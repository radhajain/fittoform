          ...
          <section className='add-item'>
            <h1>Add Dress</h1>
              <form onSubmit={this.handleSubmit}>
                ...
                <input className="add-input" type="text" name="length" placeholder="How long is the dress? e.g. mini, midi, maxi, knee, high-low" onChange={this.handleChange} value={this.state.length} />
                ...
                <input className="add-input" type="text" name="style" placeholder="What's the style of the dress? e.g. bodycon, fit-and-flare, shift, t-shirt, wrap, shift, slit" onChange={this.handleChange} value={this.state.style} />
